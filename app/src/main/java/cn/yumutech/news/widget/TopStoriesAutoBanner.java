package cn.yumutech.news.widget;
...
public class TopStoriesAutoBanner extends RelativeLayout {
    ...
    public TopStoriesAutoBanner(Context context){
        this(context, null, 0);
    }
    public TopStoriesAutoBanner(Context context, AttributeSet attrs){
        this(context, attrs, 0);
    }
    public TopStoriesAutoBanner(Context context, AttributeSet attrs, int defStyleAttr) {
